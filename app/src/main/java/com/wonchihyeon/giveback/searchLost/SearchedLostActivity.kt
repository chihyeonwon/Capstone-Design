package com.wonchihyeon.giveback.searchLost
...
import com.wonchihyeon.giveback.LostBoard.LostBoardListLVAdapter
import com.wonchihyeon.giveback.LostBoard.LostBoardModel
import com.wonchihyeon.giveback.MainActivity
import com.wonchihyeon.giveback.R
import com.wonchihyeon.giveback.databinding.ActivitySearchedLostBinding
...
class SearchedLostActivity : AppCompatActivity() {

    private val TAG = SearchedLostActivity::class.java.simpleName
    ...
    private lateinit var binding: ActivitySearchedLostBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_searched_lost)
        ...
        val postListner = object: ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                for(dataModel in dataSnapshot.children) {
                    ...
                    val sdfDate = sdf.parse(item?.lostDate)
