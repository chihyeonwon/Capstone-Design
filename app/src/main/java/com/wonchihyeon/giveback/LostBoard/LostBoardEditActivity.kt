...
import com.wonchihyeon.giveback.databinding.ActivityLostBoardEditBinding
...
class LostBoardEditActivity : AppCompatActivity() {
    ...
    private lateinit var lostSpinner: Spinner
    private lateinit var detaillost : String
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lostSpinner = findViewById(R.id.lostlocationArea)
        ...
        detaillost = binding.detaillostArea.text.toString()
    }
        ...
        FBRef.lostboardRef
            ...
            .setValue(
                LostBoardModel(
                    ...
                    binding.lostCategoryArea.text.toString(),
                    binding.lostDateArea.text.toString(),
                    lostSpinner.selectedItem.toString(),
                    binding.detaillostArea.text.toString(),
        ...
        val postListner = object: ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                if (dataModel != null) {
                    ...
                    binding.lostCategoryArea.setText(dataModel.category)
                    binding.lostDateArea.setText(dataModel.lostDate)
                    lostSpinner.setSelection(0) // 수정할 때 Spinner 인덱스를 0으로 초기화
                    binding.detaillostArea.setText(dataModel.lostdetailLocation)
